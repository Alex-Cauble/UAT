...
function ModifyStaff {
  ...
  $textBox_ModifiedDepartment.add_SelectedIndexChanged( {ModifyStaffEnableApplyButton})
  ...
  $textBox_ModifiedBuilding.add_SelectedIndexChanged( {ModifyStaffEnableApplyButton})
